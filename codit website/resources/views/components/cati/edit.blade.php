...
<li>
     <i class="fa fa-chevron-right"></i>
     <a class="nav-item px-1" href="{{route('cati.index').'/'.$cati->id.'/edit'}}">{{ __("control.edit") }}</a>
</li>
@endsection
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
            <div class="card-header">{{ __("control.edit").' '.__('words.catigury')}}</div>

            <div class="card-body">
                <form method="POST" action="{{ route("cati.index").'/'.$cati->id }}">
                @method('patch')
                    @csrf
                    <div class="mx-2">
