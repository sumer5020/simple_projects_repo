...
class uncompletedOffer implements FromGenerator, ShouldAutoSize, WithTitle, WithStyles
{
    use Exportable;
    ...
    public function generator(): Generator
    {
        ...
        $Offer_requests=offer_request::where('status',1)->get();
    ...
    public function title(): string{
        return \App::getLocale()=='ar'?'طلبات العروض غير المكتملة':'Uncompleted offer request';
    }
