...
class adminUsers implements FromGenerator, WithTitle, WithStyles
{
    use Exportable;
    ...
    public function generator(): Generator
    {
        ...
        //user info
        $users= User::where('rule',['sprov','prov'])->get(['id','name','username','phone1','phone2','email','created_at','updated_at']);
    ...
    public function title(): string{
        return \App::getLocale()=='ar'?'المدراء':'Admins';
    }
