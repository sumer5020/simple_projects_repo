...
class unactiveUser implements FromGenerator, ShouldAutoSize, WithTitle, WithStyles
{
    use Exportable;
    ...
    public function generator(): Generator
    {
        ...
        //user info
        $users= User::where('status',0)->get(['id','name','username','phone1','phone2','email','created_at','updated_at']);
    ...
    public function title(): string{
        return \App::getLocale()=='ar'?'المستخدمين المحضورين':'Unactive Users';
    }
